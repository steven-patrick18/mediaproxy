    ...
    <div className="space-y-4">
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <p className="mt-3 text-xs text-slate-400">
          ...
          <code className="font-mono"> mediaproxy-baseapp</code>. SSH on every host is managed directly
          on the box via <code className="font-mono">/etc/ssh/sshd_config</code>; the panel does not
          touch sshd.
        </p>
      </section>
